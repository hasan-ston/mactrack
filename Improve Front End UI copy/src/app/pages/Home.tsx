    ...
    <div>
      ...
      <section className="container mx-auto px-4 py-16">
        <motion.div
          ...
          viewport={{ once: true, margin: "-60px" }}
          transition={{ duration: 0.6 }}
          className="relative overflow-hidden rounded-3xl text-center p-12 md:p-20"
          style={{ background: "linear-gradient(135deg, #7A003C 0%, #5a0028 100%)" }}
        >
          {/* Decorative dots */}
          <div
            ...
            style={{
              backgroundImage: "radial-gradient(circle, rgba(255,200,69,0.1) 1px, transparent 1px)",
              backgroundSize: "28px 28px",
            }}
          />
          {/* Decorative blobs */}
          <div className="absolute top-0 right-0 w-80 h-80 rounded-full opacity-10"
            style={{ background: "radial-gradient(circle, #ffc845, transparent 70%)", transform: "translate(30%, -30%)" }} />
